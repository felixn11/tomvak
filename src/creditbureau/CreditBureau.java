 ...
 * CreditRequest-s for a loan from the LoanBroker Messaging-Orianted Middleware
...
public class CreditBureau {
    ...
    private CreditLoanBrokerGateway gtw;
    ...
    public CreditBureau(String factoryName, String creditRequestQueue, String creditReplyQueue) {
        ...
        gtw = new CreditLoanBrokerGateway(factoryName, creditRequestQueue) {
            @Override
    ...
    private void onCreditRequest(CreditRequest request) {
        try {
            ...
            gtw.sendCreditReply(request, reply);
