 ...
 * @author user
 */
public class RecieverMessagingGateway {
    ...
    private Destination recieveDestination;
    
    public RecieverMessagingGateway(String recieverDestinationStr){
        try {
            ...
            recieveDestination = getDestination(recieverDestinationStr);
    ...
    public Destination getDestination() {
        return this.recieveDestination;
    }
}
